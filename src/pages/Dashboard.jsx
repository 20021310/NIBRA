...
const Dashboard = () => {
    return (
        <div className="bg-background-deep font-sans text-slate-100 min-h-screen transition-colors duration-200 antialiased overflow-x-hidden selection:bg-primary selection:text-white">
            <div className="max-w-md mx-auto min-h-screen relative pb-20 overflow-hidden">
                {/* Background Glows */}
                <div className="fixed top-[-10%] left-[-10%] w-[500px] h-[500px] bg-primary/20 rounded-full blur-[100px] pointer-events-none z-0 mix-blend-screen"></div>
                <div className="fixed bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-blue-600/10 rounded-full blur-[80px] pointer-events-none z-0 mix-blend-screen"></div>
                ...
                <header className="sticky top-0 z-50 glass-panel px-5 py-4 flex items-center justify-between border-b border-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-lg font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-purple-200">Script Sovereignty</h1>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 p-[2px] shadow-lg shadow-purple-900/30">
                            <img alt="User Profile" className="w-full h-full rounded-full object-cover border-2 border-surface-dark" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsYMlm3KJPOYUc8NLgtUr9v92PrdBjGTQqrVD0cbNqwG3TI3zeXkb3tvVkejbJrXmJ-KMVKvT08LynDPMPGkjKDUaPQFb3H0NGayqYNmE8nbTDD497-g6RTM6tVsp4EQsXMb4_2I1HFHoP6ETJJedl2-R9Y-NHlAvm00urvN7mEt_fBZ8tcFzlFHmol_PYEneek8EyEH9WiogJPIjeHwGkMeSdvs5OjMsyWDCTdQqPSrTmiYIajRQRe1GKGWPCDVebwEh6pQD7yPI" />
                        </div>
                    </div>
                </header>
                ...
                <main className="px-5 py-6 space-y-8 relative z-10">
                    <section className="space-y-5">
                        <div className="flex justify-between items-end">
                            <div>
                                ...
                                <h2 className="text-4xl font-bold text-white tracking-tight drop-shadow-sm">12,450 <span className="text-base font-medium text-slate-400">cr</span></h2>
                            </div>
                        ...
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-surface-card to-[#130b2e] border border-white/10 shadow-2xl shadow-purple-900/20 group">
                            ...
                            <div className="relative p-6 z-10">
                                ...
                                <h3 className="text-2xl font-bold mb-1.5 text-white">Product Launch V2</h3>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="w-full bg-black/40 rounded-full h-2 overflow-hidden border border-white/5">
                                        <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 h-full rounded-full shadow-[0_0_10px_rgba(168,85,247,0.5)] relative" style={{ width: '78%' }}>
                    ...
                    <section className="space-y-5">
                        <div className="flex justify-between items-center px-1">
                            <h3 className="font-semibold text-lg text-white">Recent Renders</h3>
                        ...
                        <div className="grid gap-4">
                            <div className="bg-surface-card/60 backdrop-blur-sm p-4 rounded-2xl border border-white/5 hover:border-primary/40 transition-all duration-300 group hover:bg-surface-card/80 cursor-pointer">
                                <div className="flex gap-4">
                                    <div className="relative w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 bg-slate-800 shadow-inner">
                                        <img alt="Avatar Preview" className="w-full h-full object-cover opacity-90 group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDiK6YApyHDQHrXih7MArWnBteIvH3c1ffh04t5SJmWNMmAsqXtTjqby9nKU4g3DZYGtzKKPuFCSvHZsvjmRp4i_KZDp69ARSOo0QHUuubMeWgFgQSefj-H4SWNf5PNNhDQNGHmcpsr670Cpka-H13tQd252hHTU-jR5sdpuJri_iOR0Odjcojh6pz-1UtzOsJQt_V1CtlxtxyC6_7p6p8YhwR1ebIj4nMajazL1OIC_kp6CGepl3RLHc4cZS2kAoBuqdPdifNkplw" />
                                        <div className="absolute inset-0 bg-black/20 flex items-center justify-center group-hover:bg-black/10 transition-colors">
                                            <span className="material-symbols-outlined text-white drop-shadow-md text-3xl opacity-90 group-hover:opacity-100 group-hover:scale-110 transition-all">play_circle</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                                        <div>
                                            <h4 className="font-semibold text-base text-white truncate group-hover:text-purple-200 transition-colors">Q3 Quarterly Review</h4>
                                            <p className="text-xs text-slate-400 mt-1 truncate font-light">Avatar: Sarah (Business) • 2m 14s</p>
                                        </div>
                                        <div className="flex items-center justify-between mt-2">
                                            <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide bg-green-500/10 text-green-400 border border-green-500/20">
                                                Ready
                                            </span>
                    ...
                    <section className="grid grid-cols-2 gap-4 pt-2 pb-6">
                        <div className="p-5 rounded-2xl bg-gradient-to-br from-surface-card to-[#1a123d] border border-white/5 hover:border-indigo-500/50 flex flex-col items-center justify-center text-center space-y-3 cursor-pointer hover:shadow-[0_0_20px_rgba(99,102,241,0.15)] transition-all group">
                        ...
                        <div className="p-5 rounded-2xl bg-gradient-to-br from-surface-card to-[#1a123d] border border-white/5 hover:border-pink-500/50 flex flex-col items-center justify-center text-center space-y-3 cursor-pointer hover:shadow-[0_0_20px_rgba(236,72,153,0.15)] transition-all group">
                ...
                <button className="fixed bottom-24 right-6 w-14 h-14 bg-gradient-to-r from-primary to-purple-600 text-white rounded-full shadow-glow flex items-center justify-center hover:scale-110 active:scale-95 transition-all z-40 border border-white/20">
                ...
                <nav className="fixed bottom-0 left-0 right-0 glass-panel border-t border-white/5 px-6 py-4 z-50 safe-pb max-w-md mx-auto">
                    <ul className="flex justify-between items-center px-2">
                        <li>
                            <a className="flex flex-col items-center gap-1.5 text-primary group" href="#">
                                <span className="material-symbols-outlined group-hover:scale-110 transition-transform">dashboard</span>
                                <span className="text-[10px] font-medium tracking-wide">Home</span>
                            </a>
                        </li>
                        <li>
                            <a className="flex flex-col items-center gap-1.5 text-slate-500 hover:text-white transition-colors group" href="#">
                        ...
                        <li>
                            <a className="flex flex-col items-center gap-1.5 text-slate-500 hover:text-white transition-colors group" href="#">
                                <span className="material-symbols-outlined group-hover:scale-110 transition-transform">face</span>
