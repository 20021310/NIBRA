...
const Player = () => {
    return (
        <div className="bg-black text-gray-100 min-h-screen antialiased flex flex-col items-center justify-center py-4 px-4 sm:px-0 selection:bg-primary/30">
            <div className="w-full max-w-md h-[90vh] bg-[#09090b] shadow-2xl shadow-purple-900/10 overflow-hidden relative rounded-[2.5rem] border-[6px] border-[#1f1f22] flex flex-col">
                {/* Status Bar */}
                <div className="h-12 w-full flex justify-between items-center px-7 pt-3 select-none z-20">
                    <span className="text-xs font-semibold text-white tracking-wide">9:41</span>
                    <div className="flex gap-1.5 items-center">
                        <span className="material-icons-round text-[16px] text-white">signal_cellular_alt</span>
                        <span className="material-icons-round text-[16px] text-white">wifi</span>
                        <span className="material-icons-round text-[18px] text-white">battery_full</span>
                    </div>
                </div>

                {/* Header */}
                <div className="px-6 pb-4 pt-1 flex items-center justify-between z-10">
                    <button className="w-10 h-10 flex items-center justify-center -ml-2 rounded-full hover:bg-white/10 transition-colors">
                        <span className="material-icons-round text-white">arrow_back</span>
                    </button>
                    <h1 className="font-semibold text-xs uppercase tracking-[0.15em] text-gray-400">Review Generation</h1>
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
                            ...
                            <div className="flex items-center justify-between text-white mt-1">
                                ...
                                <div className="flex items-center gap-4">
                                    <button className="group flex items-center justify-center">
                                        <span className="material-icons-round text-xl text-gray-300 group-hover:text-white transition-colors">closed_caption</span>
                                    </button>
                                    <button className="group flex items-center justify-center">
                                        <span className="material-icons-round text-xl text-gray-300 group-hover:text-white transition-colors">fullscreen</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="px-6 mb-8">
                        <div className="flex items-start justify-between mb-3">
                            <div>
                                <h2 className="text-xl font-bold text-white mb-1.5 leading-tight">Product Launch V2</h2>
                            ...
                            <div className="w-11 h-11 rounded-full border-2 border-violet-500/50 p-0.5 shadow-glow">
                                <img
                                    alt="Avatar"
                                    className="w-full h-full rounded-full object-cover"
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-7bkFZVr9BHlNT-ZfkpP6G8HTwKYySAM-iJQIAkpt8udc9F2rgLcdcglTv0lB6fYWm3tYedIDsWIlPcXPeKOFa8hP3ZKSaiuPYV4E47TiBZ6CCyYCf8H60et1pw9CgYlVN2xn7MeZ7FhpzZjqTn89B1cV2-iYN1baCtmt7XLGHDsk11buvtdwTafM6TRU-WCrFQKJee2DJM_JX5UHTWp81LoUGUgyr3DdjqpglSipLSDS6o_FsUroG1oFNWObsEmcqo2RSWutr0M"
                                />
                            </div>
                        </div>
                        <div className="mt-5 p-4 bg-[#131318] rounded-2xl border border-white/5 flex items-start gap-3 relative overflow-hidden group">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-gray-400 leading-snug">Render matches input script with 100% accuracy.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <button className="relative p-4 rounded-2xl border border-violet-500/50 bg-violet-500/10 flex flex-col items-center justify-center gap-3 transition-all group shadow-glow">
                                ...
                                <div className="text-center text-xs">
                                    <span className="block font-bold text-white">9:16 Vertical</span>
                                    <span className="block text-violet-200/60 mt-0.5">TikTok / Reels</span>
                                </div>
                            </button>
                            <button className="relative p-4 rounded-2xl border border-white/5 bg-[#131318] flex flex-col items-center justify-center gap-3 transition-all group">
                                <span className="material-icons-round text-gray-500 text-2xl rotate-90 group-hover:text-gray-300 transition-colors">smartphone</span>
                                <div className="text-center text-xs">
                                    <span className="block font-medium text-gray-400">16:9 Landscape</span>
                                    <span className="block text-gray-600 mt-0.5">YouTube</span>
                                </div>
                            </button>
                        </div>
                    </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-[#09090b]/90 backdrop-blur-xl border-t border-white/5 p-6 z-20 pb-8">
                    <div className="flex gap-4">
                        <button className="flex-1 bg-[#1c1c22] border border-white/5 text-white font-medium py-3.5 px-4 rounded-xl flex items-center justify-center gap-2">
                            <span className="material-icons-round text-lg text-gray-400">edit</span> Edit
                        </button>
                        <button className="flex-[2] bg-purple-gradient text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-purple-900/40 flex items-center justify-center gap-2">
                            <span className="material-icons-round text-lg">download</span> Download
                        </button>
                    </div>
